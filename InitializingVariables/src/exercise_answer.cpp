 ...
 * You must declare a total of THREE variables, each of a different type, to represent the
 ...
 * You must initialize the hourly_wage to 23.50. In order to set the values for name and age you must
 * use cin and the extraction operator >> to allow the employee to enter their name and age in that
